...
model and see how it performs against the three that I created. Feel
free to experiment with variables available to educators after the
course. There is also a file in your data folder called
`sci-mo-with-text.csv` that includes data about students participation
in discussion forum, including the number of posts and psychometric
properties about their language used. You can read more about that data
in [Chapter 14 of
