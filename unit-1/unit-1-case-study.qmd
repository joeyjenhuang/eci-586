...
Second, the message in the output indicated that four of the columns were specified as "character" data types and two of the columns `student_id` and `time_spent` as double or numeric types. The student ID as numeric is problematic and something we will have to deal with later.
