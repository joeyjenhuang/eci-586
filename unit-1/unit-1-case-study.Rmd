...
Workflow from [Learning Analytics Goes to
...
product students' performance in these online courses. This case study
is guided by a foundational study in Learning Analytics that illustrates
how analyses like these can be used develop an early warning system to
educators identify students at risk of failing and intervene before that
happens. The Unit 1 case study will cover the following workflow topics:
...
Our Unit 1 Case Study is guided by a well-cited publication by two
authors that have made numerous contributions to the field of Learning
Analytics over the years. In this section, we'll do a quick review of
study to help us...
