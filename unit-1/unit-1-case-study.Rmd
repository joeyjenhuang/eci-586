...
`student_id` and `time_spent` as double or numeric types. The student ID
as numeric is problematic and something we will have to deal with later.
...
Education Using R [\@estrellado2020data].
