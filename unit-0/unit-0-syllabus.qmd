...
2.  Wickham, H., & Grolemund, G. (2016). [*R for data science: import, tidy, transform, visualize, and model data (2e)*](https://r4ds.hadley.nz). " O'Reilly Media, Inc.".

3.  Healy, K. (2018). [*Data visualization: a practical introduction*.](http://socviz.co/) Princeton University Press.

4.  Cairo, A. (2016). [*The truthful art: Data, charts, and maps for communication*.](https://catalog.lib.ncsu.edu/catalog/NCSU3923006) New Riders.

5.  Silge, J., & Robinson, D. (2017). [*Text mining with R: A tidy approach*](https://www.tidytextmining.com). O'Reilly Media, Inc..

6.  Carolan, B. V. (2013). [*Social network analysis and education: Theory, methods & applications*](https://methods.sagepub.com/book/social-network-analysis-and-education). Sage Publications.
...
1.  **Posit Cloud** (<https://posit.co/products/cloud/cloud/)> provides access to Posit's powerful set of data science tools, including **RStudio** ([https://posit.co/products/open-source/rstudio](https://posit.co/products/open-source/rstudio/)), an integrated development environment (IDE) for R and Python that includes a console and syntax-highlighting editor, as well as tools for plotting, history, debugging, and workspace management.

    -   First, register for a free Posit Cloud account at: <https://login.posit.cloud/register.>

    -   Next, access our ECI 586 Intro to Learning Analytics workspace at:

2.  **Data Camp** ([https://www.datacamp.com](https://www.datacamp.com/)) is an online learning platform with a large catalog of video tutorials, coding activities, assessments and certifications for R, Python, data science, statistics & more.
...
3.  **RPubs** (<https://rpubs.com)> is a free and easy web publishing platform for R. Throughout the course, you will be using using [R Markdown](https://rmarkdown.rstudio.com/)) and [Quarto](https://quarto.org) documents, which weave together narrative text and code to produce elegantly formatted, static and dynamic outputs formats including: [HTML](https://bookdown.org/yihui/rmarkdown/html-document.html), [PDF](https://bookdown.org/yihui/rmarkdown/pdf-document.html), [HTML5 slides](https://bookdown.org/yihui/rmarkdown/ioslides-presentation.html), [Tufte-style handouts](https://bookdown.org/yihui/rmarkdown/tufte-handouts.html), [books](https://bookdown.org/), [dashboards](https://rmarkdown.rstudio.com/flexdashboard/), [shiny applications](https://bookdown.org/yihui/rmarkdown/shiny-documents.html), [research articles](https://github.com/rstudio/rticles), [websites](https://bookdown.org/yihui/rmarkdown/rmarkdown-site.html), and more. \
    To publish these documents via RPubs, however, you will first need to create an account here: <https://rpubs.com/users/new.>

### Optional Software (Posit)

1.  **Quarto** ([https://quarto.org](https://quarto.org/)) is an open-source scientific and technical publishing system used for creating reproducible, production quality articles, presentations, dashboards, websites, blogs, and books in HTML, PDF, MS Word, ePub, and more. \
    You can download and install Quarto here: <https://quarto.org/docs/get-started/>
...
3.  **Posit Recipes** (<https://posit.cloud/learn/recipes>) provide a collection of R code snippets and instructions featuring up-to-date best practices for coding in R.

4.  **Posit** **Cheat Sheets** ([https://posit.co/resources/cheatsheets](https://posit.co/resources/cheatsheets/?_gl=1*12iba7w*_ga*MTE1MTYxMzc2NC4xNzE3ODQzNDU5*_ga_2C0WZ1JHG0*MTcxNzg1MTMwOS4zLjEuMTcxNzg1Mjk1Mi4wLjAuMA..)) also provide handy printable reference sheets to commonly used packages and their essential functions, including example code for testing them out. also provide handy reference to commonly used packages and their essential functions, including example code for testing them out.
...
4.  **LinkedIn Learning** ([https://www.linkedin.com/learning)](https://www.linkedin.com/learning) offers tutorials and training courses on R, R Studio, and Tableau. LinkedIn Learning is [available at no charge to students](https://www.lib.ncsu.edu/faq/what-is-linkedin-learning).
...
| Week 3       | **R Tutorial**: Software tutorials on critical packages and key functions used to import, wrangle, explore, model, and report "tidy" data.                                                                                         |
...
| Week 6       | **R Tutorial**: A deeper dive into the "grammar of graphics" and development of foundational skills for creating interactive data apps.                                                                                            |
...
| Week 9       | **R Tutorial**: An introduction to the Shiny package and development of interactive data apps.                                                                                                                                     |
...
| Week 12      | **R Tutorial**: Software tutorials on critical packages and key functions used to import, wrangle, explore, model, and report relational data.                                                                                     |
