...
During the third week of each unit, we'll "walk through" a basic
research workflow, or data analysis process, that will focus on a basic
analysis using Learning Analytics methods annd techniques. This getting
started task is designed to orient you to both our data analysis
assignments and to R, RStudio, and/or RMarkdown, which we'll be using to
