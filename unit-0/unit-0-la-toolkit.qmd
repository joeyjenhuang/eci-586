...
First, sign-up for an Posit Cloud account and make sure you can access our [ECI 586 Intro to Learning Analytics (2023)](https://posit.cloud/spaces/399154/join?access_code=0VTsUSIXKD1knmHEZZerH6aYg0Q-_e-TKV-a94Bp) workspace. You should see a prompt to "Join Space?" like the one below:
...
After completing the unit-0-case-study.qmd assignment, I highly recommend getting a head start on the [The Basics](#0) tutorial built into RStudio Cloud, which will be due in a few weeks. You can access these tutorials along with many other excellent primers by clicking on the Primers link in the sidebar:
