...
a.  **Examine Basic Descriptives**. We focus primarily on actors and
    edges in this case study, including the node degree measures we
    added in the previous section, and import and fairly intuitive
...
and it will show in the view pane and then you can enlarge and even save
as an image file.
