...
-   [`create_token()`](https://cran.r-project.org/web/packages/rtweet/vignettes/auth.html) Sends request to generate authorization tokens for use of the Twitter API.
...
Sentiment analysis tries to evaluate words for their emotional association. In [Text Mining with R: A Tidy Approach](https://www.tidytextmining.com/sentiment.html), Silge aand Robinson point out that,
