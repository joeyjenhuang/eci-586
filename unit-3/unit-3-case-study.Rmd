...
**Note:** It's good practice to only provide secrets interactively as we've done here, because that makes it harder to accidentally share them in either your `.Rhistory` or an `.R` file.
