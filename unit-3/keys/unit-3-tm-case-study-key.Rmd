...
By default the {rtweet} package uses a common app for all the users that only requires you to log into Twitter and authorize the rtweet app to use your account to request data from Twitter. Using the default authentication might cause problems while using rtweet, however, since you are sharing the same resource with many people!
